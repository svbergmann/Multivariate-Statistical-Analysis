...
- Cluster 1 has almost all values of the group "Hylobates".
- Cluster 2 is kind of an intermediate cluster, no group really belongs there.
- Cluster 3 has all of the group "Pongo".
- Cluster 4 has two groups, "Gorillas", as well as "Pan".
- Cluster 5 belongs to the group "Homo".
