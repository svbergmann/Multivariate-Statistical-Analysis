...
\rho\sigma^2    & \sigma^2      & 0             & \ldots        & \rho\sigma^2  \\
\rho\sigma^2    & 0             & \ddots        & \ldots        & \vdots        \\
...
&= 2 \cdot \frac{1}{\sqrt{2\pi}}exp(\frac{-x_1}{2}) \cdot \frac{1}{2} \cdot \underbrace{\int_{-\infty}^\infty \frac{1}{\sqrt{2\pi}}exp(\frac{-x_2}{2}) dx_2}_{=1 \text{ (pdf of } \mathcal{N}(0,1) \text{ over it's whole support)}} \\
...
&= 2 \cdot \frac{1}{\sqrt{2\pi}}exp(\frac{-x_2}{2}) \cdot \frac{1}{2} \cdot \underbrace{\int_{-\infty}^\infty \frac{1}{\sqrt{2\pi}}exp(\frac{-x_1}{2}) dx_1}_{=1 \text{( pdf of } \mathcal{N}(0,1) \text{ over it's whole support)}} \\
